...
import { Placer, PlacerContext } from './index';
...
storiesOf('Placer', module)
  .addDecorator(fn => <div style={{ margin: '40px' }}>{fn()}</div>)
  ...
  .add('Auto position right bottom corner with context', () => (
    <div style={{ background: '#eee', padding: 20, margin: 10 }}>
      <div style={{ background: '#fff', padding: 20, margin: 10 }}>
        <PlacerContext>
          <Placer
            presets={[
              { xAxis: 'inside-left', yAxis: 'outside-bottom' },
